...
2人のキャラクター（つの＆めがね）が掛け合いをしながらテーマを解説する雑談動画を、テーマ入力だけで全自動生成します。
...
| 名前 | 役割 | 性格 |
|------|------|------|
| つの (Tsuno) | 毒舌 / ボケ | 口が悪く斜に構えているが、どこか憎めない |
| めがね (Megane) | 冷静 / ツッコミ・解説 | 知的で落ち着いている。つのを論理的に諭す |

## 技術スタック
- **言語**: Python 3.10+
- **LLM**: Gemini API (`google-genai`) — 台本・記事・SNS文の生成
...
- **横長 (16:9)**: つの左・めがね右配置、字幕は下部中央
- **縦長 (9:16)**: つの上部・めがね下部配置、字幕は中間エリア
